 ...
 * @return A new instance of the server.init
 */
...
//Spacey
/*
		errRc = esp_bt_sleep_enable();
		if (errRc != ESP_OK) {
			log_e("esp_bt_sleep_enable: rc=%d %s", errRc, GeneralUtils::errorToString(errRc));
			return;
		}*/
#endif
